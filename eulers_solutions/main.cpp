 ...
 * \param: None
 * \return: the product of thirteen adjacent digits in the 1000-digit number that have the greatest product.
 *
 */
unsigned long long problemEight()
{
unsigned long long product = 1, num = 0;
